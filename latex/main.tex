...
\newpage
\input{contents/2_tong_quan_cong_viec}
\newpage
\input{contents/3_co_so_ly_thuyet}
\newpage
\input{contents/4_tien_xu_ly_du_lieu}
\newpage
\input{contents/models/1_random_forest} 
\newpage
\input{contents/models/model_comparison}
\newpage
\input{contents/5_ket_luan}
\newpage
%%%%%%%%%%%%%%%%%OUTRO%%%%%%%%%%%%%%%%%%%
